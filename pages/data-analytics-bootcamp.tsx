...
const DABootcampPage: NextPage = () => {
  const router = useRouter();
  const { query } = router;

  const queryOptions: QueryHookOptions = {
    variables: { slug: 'data-analytics-bootcamp' },
  };
    ...
    <Layout title={`${course.title}`}>
      <main>
        <Head>
          ...
          <meta property="og:url" content="https://www.eskwelabs.com/data-analytics-bootcamp" />
          ...
          <meta
            ...
            content="https://www.eskwelabs.com/data-analytics-bootcamp"
          />
