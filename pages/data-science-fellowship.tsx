...
const DSBootcamp: NextPage = () => {
  const router = useRouter();
  const { query } = router;

  const queryOptions: QueryHookOptions = {
    variables: { slug: 'data-science-fellowship' },
  };
    ...
    <Layout title={`${course.title}`}>
      <main>
        <Head>
          ...
          <meta property="og:url" content="https://www.eskwelabs.com/data-science-fellowship" />
          ...
          <meta
            ...
            content="https://www.eskwelabs.com/data-science-fellowship"
          />
