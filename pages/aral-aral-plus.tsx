...
const AralAralPlusPage: NextPage = () => {
  const router = useRouter();
  const { query } = router;

  const queryOptions: QueryHookOptions = {
    variables: { slug: 'aral-aral-plus' },
  };
    ...
    <Layout title={`${course.title}`}>
      <main>
        <Head>
          ...
          <meta property="og:url" content="https://www.eskwelabs.com/aral-aral-plus" />
          ...
          <meta property="twitter:url" content="https://www.eskwelabs.com/aral-aral-plus" />
...
export default AralAralPlusPage;
