...
const PrereqModal = (props: IModal): JSX.Element => {
  const { imageUrl, prereqDetailsModal, visible, closeFn } = props;
      ...
      <div className="flex items-end justify-center pb-20 pt-4 px-4 min-h-screen text-center sm:block sm:p-0">
        ...
        >
          ...
          <div className="container relative grid gap-4 md:-top-12 md:px-6">
            <ReactMarkdownWithHtml allowDangerousHtml>{prereqDetailsModal}</ReactMarkdownWithHtml>
          </div>
        </div>
      </div>
    </div>
