...
const AralAralPlusBubble = (props: ICourseBubbleProps): JSX.Element => {
  const { active } = props;
    ...
    <div className="flex flex-col">
      <Link href="/aral-aral-plus">
        <div>
          <SpeechBubble
            active={active}
            title="Aral Aral Plus"
            description="Code-along Python Notebooks"
          />
        </div>
      </Link>
...
export default AralAralPlusBubble;
