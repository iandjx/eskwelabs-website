...
import CourseSignUp from './Signup/CourseSignUp';
    ...
    <div className="fixed z-50 inset-0 overflow-y-auto">
      <div className="flex items-end justify-center pb-20 pt-4 px-4 min-h-screen text-center sm:block sm:p-0">
        ...
        >
          ...
          <div className="container relative grid gap-4 md:-top-12 px-6">
            <ReactMarkdownWithHtml allowDangerousHtml>{signupBlurb}</ReactMarkdownWithHtml>
          </div>
          <div className="container relative grid gap-4 md:-top-12 px-6">
            <CourseSignUp stepNames={stepNames} progressBar={progressBar} courseCode={courseCode} />
          </div>
        </div>
      </div>
    </div>
